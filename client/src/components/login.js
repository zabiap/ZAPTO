...
export default class Login extends React.Component {
    ...
    onSubmit = e => {
        ...
        api
            .post('http://localhost:8080/users/api/authenticate/', data)
            .then(res => {
                this.setState({
                    ...
                    <div className="row" style={{ height: '100vh' }}>
                        <div className="col-md-6 login_left" style={{ display: 'flex', alignItems: 'center', }}>
                            <div className="row" style={{ borderRight: '1px solid black', paddingTop: '100px', paddingBottom: '100px' }}>
                                <p style={{ fontSize: '40px', fontWeight: '600', width: '100%' }}>ZAPTO</p>
                                <p style={{ fontSize: '30px', fontWeight: '500' }}>TODO | LABELS | SEARCH | FILTER</p>
                                <p style={{ fontSize: '20px' }}>Enter your username and password in the form to login to your website.</p>
                        ...
                        <div className="col-md-6" style={{ display: 'flex', alignItems: 'center' }}>
                            <div className="row" style={{ width: '100%' }}>
                                <form onSubmit={this.onSubmit} style={{ padding: '50px 40px', width: '20rem', margin: '0 auto', border: '1px solid black' }}>
                                    ...
                                    <button type="submit" className="btn btn-dark" style={{ marginTop: '15px', borderRadius: '0px', marginRight:'30px' }}>SUBMIT</button>
                                    <a href="/sign_up" className="btn btn-dark" style={{ marginTop: '15px', borderRadius: '0px', color:'#FFF' }}>SIGN UP</a>
                                </form>
                            </div>
                        </div>
                    </div>
